...
export class RasteredBumpmap {
    constructor(image, rasterWidth, rasterHeight) {
     ...
     */
    getHeightAt(ratioX, ratioY) {
        const x = Math.floor((this.width - 1) * GeometryGenerationHelpers.clamp(ratioX, 0.0, 1.0));
        const y = Math.floor((this.height - 1) * GeometryGenerationHelpers.clamp(ratioY, 0.0, 1.0));
        ...
        const brightness = (0.21 * pixel.r + 0.72 * pixel.g + 0.07 * pixel.b) / 255;
        return brightness;
    }
    /**
