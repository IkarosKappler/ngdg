...
// +-------------------------------
// var buildId = null;
export const rebuild = (appContex) => {
    return () => {
                ...
                window.setTimeout((function (bId) {
                    return function () {
                        ...
                        if (appContex.config.useBumpmap && ImageStore.isImageLoaded(appContex.bumpmapRasterImage)) {
                            ...
                            appContex.bumpmap = new RasteredBumpmap(appContex.bumpmapRasterImage, appContex.config.shapeSegmentCount, appContex.config.outlineSegmentCount);
                        }
