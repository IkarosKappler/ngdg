...
// +-------------------------------
export const updateSilhouette = (appContext) => {
    return (noRedraw) => {
        // TODO: baseShape updating belongs elsewhere!
        const baseRadius = appContext.outline.getBounds().width;
        appContext.baseShape = ngdg.GeometryGenerationHelpers.mkCircularPolygon(baseRadius, appContext.config.shapeSegmentCount, appContext.config.baseShapeExcentricity);
