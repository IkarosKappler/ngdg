...
export class DildoRandomizer {
    constructor(bounds, minPathSegments, maxPathSegments, minBendAngle, maxBendAngle) {
        this.bounds = bounds;
    ...
    randomizedPathVertices(vertexCount) {
        ...
        for (var i = 1; i + 1 < vertexCount; i++) {
            ...
            const segmendBounds = new Bounds({ x: this.bounds.min.x + this.bounds.width * 0.25, y: this.bounds.max.y - i * (this.bounds.height / vertexCount) }, {
