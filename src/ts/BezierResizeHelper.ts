...
export class BezierResizeHelper {
  ...
  public verticalResizeHandle: Vertex;
  public horizontalResizeHandle: Vertex;

  private verticalResizeHandleDragStartPosition: Vertex;
  private horizontalResizeHandleDragStartPosition: Vertex;
  private __listeners: Array<() => void>;
