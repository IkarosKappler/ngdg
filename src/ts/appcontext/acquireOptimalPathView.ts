...
// +-------------------------------
export const acquireOptimalPathView = (appContext: AppContext) => {
  return (pb: PlotBoilerplate, outline: BezierPath) => {
    ...
    (pb as any).setZoom(newZoomFactor, newZoomFactor, { x: 0, y: 0 });
    ...
    // TODO: the next version of PlotBoilerplate will habe this public :)
    (pb as any).setOffset({ x: drawOffsetX, y: drawOffsetY });
